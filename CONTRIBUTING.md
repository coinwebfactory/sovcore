Contributing to zSov Core
============================

The zSov Core project operates an open contributor model where anyone is
...
The following applies to code changes to the zSov Core project, and is not to be
confused with overall zSov Network Protocol consensus changes.

Whether a pull request is merged into zSov Core rests with the project merge
...
Patches that change zSov consensus rules are considerably more involved than
...
Where a patch set proposes to change the zSov consensus, it must have been
...
The project leader is the release manager for each zSov Core release.
