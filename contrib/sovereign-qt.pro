...
RESOURCES += src/qt/zsov.qrc src/qt/zsov_locale.qrc

TRANSLATIONS += src/qt/locale/zsov_bg.ts \
                src/qt/locale/zsov_de.ts \
                src/qt/locale/zsov_en.ts \
                src/qt/locale/zsov_es.ts \
                src/qt/locale/zsov_fi.ts \
                src/qt/locale/zsov_fr.ts \
                src/qt/locale/zsov_it.ts \
                src/qt/locale/zsov_ja.ts \
                src/qt/locale/zsov_pl.ts \
                src/qt/locale/zsov_pt.ts \
                src/qt/locale/zsov_ru.ts \
                src/qt/locale/zsov_sk.ts \
                src/qt/locale/zsov_sv.ts \
                src/qt/locale/zsov_vi.ts \
                src/qt/locale/zsov_zh_CN.ts \
                src/qt/locale/zsov_zh_TW.ts
