...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("zSov Core zsov-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zsov-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zsov transaction") + "\n" +
                               "  zsov-tx [options] -create [commands]   " + _("Create hex-encoded zsov transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zsov transaction
