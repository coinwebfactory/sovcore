...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* zSov features */
        {"zsov", "masternode", &masternode, true, true, false},
        {"zsov", "listmasternodes", &listmasternodes, true, true, false},
        {"zsov", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zsov", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zsov", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zsov", "masternodedebug", &masternodedebug, true, true, false},
        {"zsov", "startmasternode", &startmasternode, true, true, false},
        {"zsov", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zsov", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zsov", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zsov", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zsov", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zsov", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zsov", "mnbudget", &mnbudget, true, true, false},
        {"zsov", "preparebudget", &preparebudget, true, true, false},
        {"zsov", "submitbudget", &submitbudget, true, true, false},
        {"zsov", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zsov", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zsov", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zsov", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zsov", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zsov", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zsov", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zsov", "checkbudgets", &checkbudgets, true, true, false},
        {"zsov", "mnsync", &mnsync, true, true, false},
        {"zsov", "spork", &spork, true, true, false},
        {"zsov", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zsov", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zsovd, or the -server option to zsov-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zsov-cli " + methodname + " " + args + "\n";
}
