                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Sovereign Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a zSov address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zsov: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSOV"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Sovereign Core"), this);
    aboutAction->setStatusTip(tr("Show information about Sovereign Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for zSov"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your zSov addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified zSov addresses"));
    ...
    openAction->setStatusTip(tr("Open a zSov: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Sovereign Core help message to get a list with possible zSov command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Sovereign Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to zSov network", "", count));
}
...
{
    QString strTitle = tr("Sovereign Core"); // default title
