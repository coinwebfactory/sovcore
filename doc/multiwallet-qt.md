...
In order to support loading of multiple wallets in zsov-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zsov.cpp.
...
Changes to zsov.cpp
----------------------
zsov.cpp is the entry point into zsov-qt, and as such, will require some minor modifications to provide hooks for
